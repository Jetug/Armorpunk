package com.jetug.chassis_addon.common.foundation.block.entity;

import com.jetug.chassis_addon.common.foundation.registery.BlockEntityRegistry;
import com.jetug.chassis_core.common.foundation.block.entity.BlockEntityBase;
...
//        if(hasRecipe(blockEntity) && hasNotReachedStackLimit(blockEntity)) craftItem(blockEntity);
        ...
        var entities = level.getEntitiesOfClass(WearableChassis.class, aabb);
